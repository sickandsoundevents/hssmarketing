...
const CFG = {
  weeztixClientId: process.env.WEEZTIX_CLIENT_ID || "",
  weeztixClientSecret: process.env.WEEZTIX_CLIENT_SECRET || "",
  weeztixCompanyId: process.env.WEEZTIX_COMPANY_ID || "",
  metaToken: process.env.META_ACCESS_TOKEN || "",
  metaAdAccount: process.env.META_AD_ACCOUNT_ID || "", // Format: act_1234567890
