...
const BUILD = "11"; // erhoehen bei jeder Aenderung, sichtbar unter /api/status
...
// Diagnose: nutzt den echten Abruf und zeigt Anzahl plus erste Bestellung.
app.get("/api/raw", async (req, res) => {
  try {
    const orders = await fetchWeeztixOrders();
    res.json({ count: orders.length, firstOrder: orders[0] || null });
  } catch (e) {
